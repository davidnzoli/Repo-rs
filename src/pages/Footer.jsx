      ...
      <div className="Footer-section">
        <div className="one-blog">
          <div className="one-blog-content">
            <div className="para-ancre">
              ...
              <p id="para-one-blog " className="over">
                <a id="h" href="#apropos">
                  Qui somme nous
                </a>
              </p>
              <p id="para-one-blog " className="over">
                <a href="#apropos">Nos compétences</a>
              </p>
              <p id="para-one-blog " className="over">
                <a href="#apropos">Nos objectifs et Mission</a>
              </p>
            </div>
          ...
          <div className="one-blog-content sociaux">
            ...
            <div className="some-texte-sociaux">
              <p id="para-sociaux">
                Contactez nous sur le réseaux sociaux on est à la disponibilité
                de tout le monde. Vous avez besoin de nous vous n'avez qu'à nous
                écrire.
              </p>
            </div>
          </div>
          <div className="one-blog-content">
            ...
            <div className="local">
              ...
              <p id="para-local">Nord-kivu, Q/Kasika</p>
              <p id="para-local">Av/Mbati, route principale SAKE</p>
            </div>
          </div>
        </div>
        <div className="copirigth">
          ...
          <div className="ancre-pop">
            <a href="#accueil" id="ancre2">
              ACCUEIL
            </a>
            <a href="#apropos" id="ancre2">
              A PROPOS
            </a>
            <a href="#contact" id="ancre2">
              CONTACT
            </a>
          </div>
        </div>
